"""postgres: canonical domain-model tables (dm_* + scanner_insights)

Revision ID: 20260503_10_domain_model_tables
Revises: 20260426_09_timeline_events
"""

from alembic import op
import sqlalchemy as sa

revision = '20260503_10_domain_model_tables'
down_revision = '20260426_09_timeline_events'
branch_labels = None
depends_on = None
...
"""))
    ...
    op.execute(sa.text("""
CREATE TABLE IF NOT EXISTS scanner_insights (
