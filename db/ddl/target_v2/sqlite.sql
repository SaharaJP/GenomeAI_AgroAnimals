-- Canonical Data Model v2 (Target) - SQLite DDL
-- NOTE: This is additive; MVP can continue using file-based artifacts.
...
CREATE TABLE IF NOT EXISTS dm_economics_daily (
  ...
  farm_id TEXT NOT NULL,
  date TEXT NOT NULL,
  milk_price_per_kg REAL,
  feed_cost_per_kg_dm REAL,
  other_cost_eur REAL,
  created_at TEXT,
  updated_at TEXT,
  PRIMARY KEY (tenant_id, record_id),
